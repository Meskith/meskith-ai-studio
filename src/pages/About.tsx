        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            ...
            <span className="inline-block relative">
              ...
              >
                <defs>
                  <linearGradient id="aboutSpectrumGradient" x1="0%" y1="0%" x2="100%" y2="0%">
                  ...
                  <filter id="aboutGlowFilter" x="-50%" y="-50%" width="200%" height="200%">
                ...
                <motion.path
                  ...
                  fill="none"
                  stroke="url(#aboutSpectrumGradient)"
                  strokeWidth="3"
                  strokeLinecap="round"
                  filter="url(#aboutGlowFilter)"
