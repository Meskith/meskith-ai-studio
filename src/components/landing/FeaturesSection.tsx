      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Our platform handles the complexity of multi-market advertising so you can focus on growing your brand.
          </p>
        </motion.div>
          ...
          {features.map((feature) => {
            ...
            return (
              <motion.div key={feature.title} variants={itemVariants}>
                <Link to="/auth">
                  <Card className="glass-card group hover:border-primary/30 transition-all duration-500 h-full overflow-hidden cursor-pointer">
                    <CardContent className="p-8 relative text-center">
                      ...
                      <div className="p-4 rounded-2xl bg-gradient-button w-fit mb-6 mx-auto transition-transform duration-300 group-hover:scale-110">
                      ...
                      <span className="inline-flex items-center gap-2 text-primary font-medium group/link">
